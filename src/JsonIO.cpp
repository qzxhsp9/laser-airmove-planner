...
void writeSummaryJson(const std::filesystem::path& path, const PlanningResult& result) {
    ...
    json summary{
        ...
        {"shortcut_waypoints", result.shortcut_path.size()},
        ...
        {"shortcut_path_length", result.shortcut_path_length},
        ...
        {"smoothing_attempted", result.smoothing_attempted},
        {"smoothing_used", result.smoothing_used},
        {"smoothing_fallback", result.smoothing_fallback},
        {"smoothing_message", result.smoothing_message},
